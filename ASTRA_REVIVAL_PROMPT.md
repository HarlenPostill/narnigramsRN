...
- App Check plan/configuration appropriate to Expo builds. If full enforcement cannot be safely completed without console credentials, implement the code/config scaffolding, document exact console steps, and keep local emulators usable.
